...
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : ((global =
      ...
      factory((global.uiVite = {}), global.Vue));
  ...
  const Button = vue.defineComponent({
    ...
    setup(props2, { slots }) {
      ...
      console.log(
        `html`,
        (_a = document.querySelector(`#app`)) == null ? void 0 : _a.innerHTML
      );
      const size = {
        small: {
          x: "2",
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return (
      vue.openBlock(), vue.createElementBlock("button", null, "button template")
    );
  }
  const TButton = /* @__PURE__ */ _export_sfc(_sfc_main, [
    ["render", _sfc_render],
  ]);
...
//# sourceMappingURL=ui-vite.umd.js.map
